...
export const getCharacterBy = async ({ id }: { id: string }) => {
  const response = await fetch(
    `${api_marvel}characters/${id}?ts=1&apikey=bd83974f8c0124c0b4006bb69fecc3b4&hash=6253d203f94171a77b3b7f026a16e3b7`
  );
...
export const getComics = async () => {
  const response = await fetch(
    `${api_marvel}comics?limit=48&ts=${ts}&apikey=${token_marvel}&hash=${hash}`
  );
